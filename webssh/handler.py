...
class IndexHandler(MixinHandler, tornado.web.RequestHandler):
    ...
    def get_privatekey(self):
        try:
            ...
            logging.info('Privatekey by file')
        except TypeError:
            privatekey = self.get_argument('privatekey')
            logging.info('Privatekey by argument')
            return privatekey
    ...
    def get_args(self):
        ...
        if not (privatekey or password):
            raise ValueError('Privatekey and Password must has one.')
